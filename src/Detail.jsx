      ...
      <div>
        <div className="flex flex-col md:flex-row items-center">
          <div className="flex flex-row items-center">
            <img
              className="mt-3 rounded-md border-2 border-gray-400"
              src={data.flags.png}
          ...
          <div className="md:ml-5 mt-3">
            ...
            <p className="text-gray-500 text-xl">
              Region: {data.region} | Capital: {data.capital}
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div>
            ...
            <p className="ml-8">
              {data.independent ? "Independent" : "Not Independent"}
            </p>
            ...
            >
              <button className="bg-purple-950 text-white font-medium p-1 rounded-lg ml-8 mt-1">
                Open Now!
              </button>
            </a>
          </div>
